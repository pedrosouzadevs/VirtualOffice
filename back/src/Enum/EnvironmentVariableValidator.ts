...
`),
    ...
    SECURITY_EMAIL: z
        ...
        .optional()
        .describe(
            'This email address will be notified if your ArqueumSpace version contains a known security flaw. ENABLE_TELEMETRY must be set to "true" for this.',
        ),
    TELEMETRY_URL: z
        .string()
        .optional()
    ...
    SENTRY_DSN: z.string().optional().describe("If set, ArqueumSpace will send errors to Sentry"),
    SENTRY_RELEASE: z
        .string()
        .optional()
