...
export class WorkadventureModalCommands extends IframeApiContribution<WorkadventureModalCommands> {
     ...
     * {@link http://arqueum.localhost/map-building/api-ui.md#open-the-modal-iframe | Website documentation}
     */
     ...
     * {@link http://arqueum.localhost/map-building/api-ui.md#close-the-chat-window | Website documentation}
     */
    closeModal(): void {
