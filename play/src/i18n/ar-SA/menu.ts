...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "تقليل الضوضاء من ArqueumSpace",
            workAdventureNoiseSuppressionDescription: "معالجة صوت الميكروفون باستخدام تقليل الضوضاء في ArqueumSpace.",
            recommended: "موصى به",
        ...
        privacySettings: {
            ...
            explanation: 'إذا لم يكن تبويب ArqueumSpace نشطًا، سيتم التبديل إلى "وضع الغياب".', // If the ArqueumSpace tab is not active, it will switch to "absence mode".
