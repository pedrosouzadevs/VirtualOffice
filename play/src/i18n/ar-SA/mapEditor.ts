...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "فتح رابط",
            description: "فتح موقع ويب داخل ArqueumSpace أو في تبويب جديد.",
        ...
        youtube: {
            ...
            description: "فتح فيديو يوتيوب داخل ArqueumSpace أو في تبويب جديد.",
        ...
        googleDocs: {
            ...
            description: "فتح مستندات جوجل داخل ArqueumSpace أو في تبويب جديد.",
        ...
        klaxoon: {
            label: "فتح Klaxoon",
            description: "فتح Klaxoon داخل ArqueumSpace أو في تبويب جديد.",
        ...
        googleSheets: {
            ...
            description: "فتح جداول جوجل داخل ArqueumSpace أو في تبويب جديد.",
        ...
        googleSlides: {
            label: "فتح عروض جوجل",
            description: "فتح عروض جوجل داخل ArqueumSpace أو في تبويب جديد.",
        ...
        googleDrive: {
            ...
            description: "فتح Google Drive داخل ArqueumSpace أو في تبويب جديد.",
        ...
        openFile: {
            label: "فتح ملف",
            description: "افتح ملفًا داخل ArqueumSpace.",
        ...
        lockableAreaPropertyData: {
            ...
            ownerModeLabel: "وضع المالك (قفل دائم)",
            ownerModeInfo:
                "يمكن فقط لمالك المنطقة الشخصية القفل أو الفتح، ويبقى القفل عندما تفرغ المنطقة. يتطلب خاصية منطقة شخصية في هذه المنطقة نفسها.",
        },
