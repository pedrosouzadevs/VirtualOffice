...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "المتصفح الخاص بك ({browserName}) لم يعد مدعوماً من ArqueumSpace.",
        description: "متصفحك قديم جداً لتشغيل ArqueumSpace. يرجى تحديثه إلى أحدث إصدار للمتابعة.",
        whatToDo: "ماذا يمكنك أن تفعل؟",
        option1: "تحديث {browserName} إلى أحدث إصدار",
        option2: "مغادرة ArqueumSpace واستخدام متصفح مختلف",
        updateBrowser: "تحديث المتصفح",
        leave: "مغادرة",
    },
    pwaInstall: {
        title: "تثبيت ArqueumSpace",
        description: "ثبّت التطبيق للحصول على تجربة أفضل: وصول سريع، وتشغيل عند بدء التشغيل، وتجربة شبيهة بالتطبيقات.",
        descriptionIos: "أضف ArqueumSpace إلى الشاشة الرئيسية للحصول على تجربة أفضل ووصول سريع.",
        feature1Title: "وصول سريع",
        feature1Description: "شغّل ArqueumSpace من قائمة ابدأ أو الـ Dock أو سطح المكتب.",
        feature2Title: "نافذة تطبيق مستقلة",
        feature2Description: "أبقِ ArqueumSpace منفصلًا عن علامات تبويب المتصفح واعثر عليه بسرعة في شريط المهام.",
        feature3Title: "ابدأ مع تشغيل الجهاز",
        feature3Description: "شغّل ArqueumSpace عند بدء تشغيل جهازك.",
        ...
        install: "تثبيت تطبيق ArqueumSpace",
