...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Supresión de ruido de ArqueumSpace",
            workAdventureNoiseSuppressionDescription:
                "Procesa tu micrófono con la supresión de ruido de ArqueumSpace.",
        ...
        privacySettings: {
            ...
            explanation:
                'Cuando la pestaña de ArqueumSpace en su navegador no es visible, ArqueumSpace cambia a "modo no presente"',
    ...
    contact: {
        gettingStarted: {
            title: "Empezar",
            description:
                "ArqueumSpace le permite crear un espacio en línea para comunicarse espontáneamente con otros. Y todo empieza creando su propio espacio. Escoja de una gran selección de mapas prefabricados por nuestro equipo.",
        },
        createMap: {
            title: "Crear su mapa",
