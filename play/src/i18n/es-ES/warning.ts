...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Su navegador ({browserName}) ya no es compatible con ArqueumSpace.",
        description:
            "Su navegador es demasiado antiguo para ejecutar ArqueumSpace. Por favor, actualícelo a la última versión para continuar.",
        whatToDo: "¿Qué puede hacer?",
        option1: "Actualizar {browserName} a la última versión",
        option2: "Salir de ArqueumSpace y usar un navegador diferente",
    ...
    pwaInstall: {
        ...
        descriptionIos:
            "Añade ArqueumSpace a tu pantalla de inicio para disfrutar de una mejor experiencia y un acceso rápido.",
        feature1Title: "Acceso rápido",
        feature1Description: "Abre ArqueumSpace desde tu menú Inicio, Dock o escritorio.",
        feature2Title: "Ventana de aplicación dedicada",
        feature2Description:
            "Mantén ArqueumSpace separado de las pestañas del navegador y encuéntralo de un vistazo en la barra de tareas.",
        feature3Title: "Iniciar con el ordenador",
        feature3Description: "Abre ArqueumSpace cuando se inicie tu dispositivo.",
        ...
        install: "Instalar la app ArqueumSpace",
