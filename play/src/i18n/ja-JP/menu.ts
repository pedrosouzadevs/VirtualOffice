...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "ArqueumSpace ノイズ抑制",
            workAdventureNoiseSuppressionDescription: "ArqueumSpace のノイズ抑制でマイク音声を処理します。",
            recommended: "推奨",
        ...
        privacySettings: {
            title: "離席モード",
            explanation:
                "ブラウザの ArqueumSpace タブが表示されていない間、ArqueumSpace は離席モードに切り替わります。",
    ...
    contact: {
        gettingStarted: {
            title: "入門",
            description:
                "ArqueumSpace を使用すると、他のユーザと自然にコミュニケーションできるオンラインスペースを作成することができます",
        },
        createMap: {
            title: "マップを作成します",
