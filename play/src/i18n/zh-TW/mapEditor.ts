...
const mapEditor: DeepPartial<Translation["mapEditor"]> = {
    ...
    properties: {
        ...
        openWebsite: {
            label: "開啟連結",
            description: "在 ArqueumSpace 內或以新分頁開啟網站。",
            linkLabel: "連結 URL",
            newTabLabel: "在新分頁中開啟",
            trigger: "互動",
            triggerMessage: "提示訊息",
        ...
        youtube: {
            label: "開啟 YouTube 影片",
            description: "在 ArqueumSpace 內或以新分頁開啟 YouTube 影片。",
        ...
        googleDocs: {
            label: "開啟 Google 文件",
            description: "在 ArqueumSpace 內或以新分頁開啟 Google 文件。",
        ...
        klaxoon: {
            label: "開啟 Klaxoon",
            description: "在 ArqueumSpace 內或以新分頁開啟 Klaxoon。",
        ...
        googleSheets: {
            label: "開啟 Google 試算表",
            description: "在 ArqueumSpace 內或以新分頁開啟 Google 試算表。",
        ...
        googleSlides: {
            label: "開啟 Google 簡報",
            description: "在 ArqueumSpace 內或以新分頁開啟 Google 簡報。",
        ...
        googleDrive: {
            ...
            description: "在 ArqueumSpace 內或以新分頁開啟 Google 雲端硬碟。",
        ...
        openFile: {
            label: "開啟檔案",
            description: "在 ArqueumSpace 內開啟檔案。",
            error: "請輸入有效的檔案",
            disabled: "檔案整合已停用。",
            fileUrlLabel: "檔案 URL",
            uploadFile: {
    ...
    floorEditor: {
        downloadConsolidated: "下載合併後的 .tmj",
        clearOverlay: "清除結構編輯",
        clearOverlayConfirm: "清除所有結構編輯並讓所有人重新載入基礎地圖？重新載入後無法復原。",
        modePaint: "地板",
        modeWall: "牆壁",
        modeErase: "橡皮擦",
        targetLayer: "圖層",
        palette: "圖塊",
        selectTileHint: "在調色盤中選擇一個圖塊開始繪製。",
        wallModeDegraded: '此地圖沒有碰撞標記圖塊或 "collisions" 圖層：牆壁將僅為視覺效果。',
        eraseHint: "在地圖上點擊或拖曳以擦除圖塊（同時解除該格子的碰撞）。",
    },
    explorer: {
        title: "探索房間",
        description:
