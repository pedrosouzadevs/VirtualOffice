...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "Verpasse keine Diskussion. Aktiviere Benachrichtigungen, um informiert zu werden, wenn jemand mit dir sprechen möchte, auch wenn du nicht im ArqueumSpace-Tab bist.",
        firefoxContent:
