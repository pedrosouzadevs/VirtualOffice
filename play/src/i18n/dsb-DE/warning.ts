...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Waš wobglědowak ({browserName}) se wěcej njepódpěra wót ArqueumSpace.",
        description:
            "Waš wobglědowak jo pśestaršy, aby ArqueumSpace wuwjadł. Pšosym aktualizěrujśo jogo na nejnowšu wersiju, aby pókšacowali.",
        whatToDo: "Co móžośo cyniś?",
        option1: "{browserName} na nejnowšu wersiju aktualizěrowaś",
        option2: "ArqueumSpace wopušćiś a drugi wobglědowak wužywaś",
        updateBrowser: "Wobglědowak aktualizěrowaś",
        leave: "Wopušćiś",
    },
    pwaInstall: {
        title: "ArqueumSpace instalěrowaś",
        description:
            "Instalěrujśo app za lěpše dožywjenje: malsny pśistup, start pśi zachopjenju a dožywjenje ako w app.",
        descriptionIos: "Pśidajśo ArqueumSpace k startowemu wobrazoju za lěpše dožywjenje a malsny pśistup.",
        feature1Title: "Malsny pśistup",
        feature1Description: "Startujśo ArqueumSpace ze startowego menija, Docka abo z desktopa.",
        feature2Title: "Swójske wokno app",
        feature2Description:
            "Źaržćo ArqueumSpace wótkźělone wót rejtarikow wobglědowaka a namakajśo jo malsnje w swójej nadawkowej rědce.",
        feature3Title: "Ze swójim kompjutarom startowaś",
        feature3Description: "Startujśo ArqueumSpace, gaž se waš rěd zachopijo.",
        ...
        install: "ArqueumSpace-app instalěrowaś",
