...
:::info
This feature requires a Matrix server. If you are using ArqueumSpace SaaS, we already provide a Matrix server out-of-the-box. If you are self-hosting, be sure to connect a Matrix server to your install.
:::
