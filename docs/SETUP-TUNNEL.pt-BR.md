...
> mesmos parâmetros — o script é compatível com o 5.1 de propósito. O que realmente falta é o Azure CLI:
> `winget install --exact --id Microsoft.AzureCLI`, **feche e reabra o terminal**, e `az login`.
