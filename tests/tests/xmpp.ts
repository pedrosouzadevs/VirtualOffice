...
//
// fixture `XMPP`
//     .page `/_/global/maps.arqueum.localhost/tests/mousewheel.json`;
//
...
//
//     await login(t, '/_/global/maps.arqueum.localhost/tests/mousewheel.json');
//
//     await t
//         .click(userListBtn)
...
//     const bobWindow = await t.openWindow('/_/global/maps.arqueum.localhost/tests/mousewheel.json');
//
//     await t.resizeWindow(960, 800);
//
//     await login(t, '/_/global/maps.arqueum.localhost/tests/mousewheel.json', 'Bob', 3);
//
//     await t
//         .click(userListBtn)
//         .expect(userList.innerText).contains('Alice')
